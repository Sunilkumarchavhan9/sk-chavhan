...
export function AnimatedThemeToggler() {
  ...
  return (
    <button
      ...
      className="relative inline-flex items-center justify-center rounded-md px-3 py-2 text-foreground transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 hover:bg-accent hover:text-accent-foreground"
    >
